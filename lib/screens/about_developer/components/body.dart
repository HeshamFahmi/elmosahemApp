          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                ...
                InkWell(
                  onTap: () async {
                    const String linkedInUrl = "لينك لينكد ان";
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        const String githubUrl =
                            "https://github.com/mohanedmostafa";
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        const String linkedInUrl =
                            "https://www.linkedin.com/in/mohanedmostafa";
                        await launchUrl(linkedInUrl);
                      },
                    ),
                    IconButton(
                      ...
                      onPressed: () async {
                        const String instaUrl =
                            "https://www.instagram.com/mohandmostfa";
  ...
  Future<void> submitAppReview(BuildContext context,
    ...
    if (result != null) {
      ...
      try {
        ...
        if (reviewAdded == true) {
          snackbarMessage = "تم اضافه رأيك بنجاح";
        } else {
