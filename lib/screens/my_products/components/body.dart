...
import '../../../services/data_streams/users_products_stream.dart';
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Center(
                          child: NothingToShowContainer(
                            ...
                            primaryMessage: "حدث خطأ حاول مره اخري",
                            secondaryMessage: "حدث خطأ حاول مره اخري",
                          ),
                        );
                      },
                    ),
    ...
    return Dismissible(
      ...
      confirmDismiss: (direction) async {
        if (direction == DismissDirection.startToEnd) {
            ...
            try {
              ...
              productInfoDeleted = await showDialog(
                ...
                builder: (context) {
                  return AsyncProgressDialog(
                    deleteProductFuture,
                    message: Text("حذف الخدمه"),
                  );
                },
              );
              if (productInfoDeleted == true) {
                snackbarMessage = "تم الحذف بنجاح";
              } else {
          ...
          final confirmation =
              await showConfirmationDialog(context, "هل تريد تعديل الخدمه؟");
          if (confirmation) {
