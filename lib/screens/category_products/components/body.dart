...
import '../../../services/data_streams/category_products_stream.dart';
                      ...
                      builder: (context, snapshot) {
                          ...
                          if (productsId.length == 0) {
                            return Center(
                              child: NothingToShowContainer(
                                secondaryMessage:
                                    "لا يوجد خدمات في ${EnumToString.convertToString(widget.productType)}",
                              ),
                            );
                          }
                        ...
                        return Center(
                          child: NothingToShowContainer(
                            ...
                            primaryMessage: "حدث خطأ",
                            secondaryMessage: "حدث خطأ",
                          ),
                        );
                      },
                    ),
