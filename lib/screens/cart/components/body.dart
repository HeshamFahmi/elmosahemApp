          ...
          if (confirmation) {
            if (direction == DismissDirection.startToEnd) {
              ...
              try {
                ...
                if (result == true) {
                  snackbarMessage = "تم الازاله بنجاح";
                  await refreshPage();
                } else {
                  throw "تعذر الازاله حاول مره اخري";
                }
              } on FirebaseException catch (e) {
                Logger().w("Firebase Exception: $e");
                snackbarMessage = "حدث خطأ";
              } catch (e) {
      ...
      if (orderedProductsUid != null) {
        ...
        try {
          ...
          if (addedProductsToMyProducts) {
            snackbarmMessage = "تم الشراء بنجاح";
          } else {
            throw "تعذر الشراء";
          }
        } on FirebaseException catch (e) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(snackbarmMessage ?? "حدث خطأ"),
            ),
          );
        }
      } else {
        throw "تعذر ازاله الكل من السله";
      }
      await showDialog(
        context: context,
        builder: (context) {
