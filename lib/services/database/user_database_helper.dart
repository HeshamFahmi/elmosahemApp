...
class UserDatabaseHelper {
  ...
  static const String NID_KEY = "national_id_picture";
  static const String SEL_KEY = "selfie_picture";
  ...
  String getPathForCurrentUserNationalIdPicture() {
    final String currentUserUid = AuthentificationService().currentUser.uid;
    return "user/national_id_picture/$currentUserUid";
  }

  String getPathForCurrentUserSelfiePicture() {
    final String currentUserUid = AuthentificationService().currentUser.uid;
    return "user/selfie_picture/$currentUserUid";
  }
  ...
  Future<bool> uploadNationalIDPictureForCurrentUser(String url) async {
    String uid = AuthentificationService().currentUser.uid;
    final userDocSnapshot =
        firestore.collection(USERS_COLLECTION_NAME).doc(uid);
    await userDocSnapshot.update(
  ...
  Future<bool> uploadSelfiePictureForCurrentUser(String url) async {
    String uid = AuthentificationService().currentUser.uid;
    final userDocSnapshot =
        firestore.collection(USERS_COLLECTION_NAME).doc(uid);
    await userDocSnapshot.update(
